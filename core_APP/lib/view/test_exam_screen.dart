...
class _TestExamScreenState extends State<TestExamScreen> {
  ...
  Future<void> fetchQuestions() async {
    ...
    try {
      ...
      final response = await http.get(
        ...
        Uri.parse(
          'https://core-backend-38rr.onrender.com/api/questions/test/${widget.testId}',
        ),
      ...
      if (data['success'] == true) {
        ...
        if (_questions.isNotEmpty) {
          ...
          _selectedSubject = _questions.first.subject;
        }

        _selectedAnswers =
            List.generate(_questions.length, (index) => null);
  ...
  void _nextQuestion() {
    ...
    if (_currentIndex < _questions.length - 1) {
      ...
      setState(() {
        ...
        _selectedSubject =
            _questions[_currentIndex].subject;
      });
  ...
  Future<void> submitTest() async {
    ...
    try {
      ...
      for (int i = 0; i < _questions.length; i++) {
        ...
        if (_selectedAnswers[i] != null) {
          ...
          answers.add({
            ...
            "question": _questions[i].id,

            "selectedOption":
            (_selectedAnswers[i]! + 1).toString(),
          });
        }
      }
      ...
      final response = await http.post(
        ...
        Uri.parse(
          'https://core-backend-38rr.onrender.com/api/test-attempt/submit',
        ),
      ...
      if ((response.statusCode == 200 ||
        ...
        final analysisResponse = await http.get(
          ...
          Uri.parse(
            'https://core-backend-38rr.onrender.com/api/test-attempt/performance-analysis',
          ),
        ...
        debugPrint(
          "ANALYSIS RESPONSE => ${analysisResponse.body}",
        );

        final analysisData =
        jsonDecode(analysisResponse.body);

        // ================= NAVIGATION =================

        // API call ke baad...
        debugPrint("API Response success, attempting navigation...");

        if (mounted) {
          debugPrint("Mounted is true, navigating now...");
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (_) => ResultDashboardScreen(resultData: analysisData)),
          );
        } else {
          debugPrint("Navigation failed: Widget is no longer mounted.");
        }
  ...
  Widget build(BuildContext context) {
    ...
    final displayIndex =
        filteredIndices.indexOf(_currentIndex) + 1;

    return Scaffold(

      backgroundColor: const Color(0xFF0A0304),
...
// }
//
// Future<void> getPerformanceAnalysis() async {
//
//   try {
//
...
//       context,
//       MaterialPageRoute(
//         builder: (_) => ResultDashboardScreen(
//           resultData: data,
//         ),
//       ),
//     );
...
// _selectedSubject = subject;
//
// _currentIndex = _questions.indexWhere(
// (q) => q.subject == subject,
// );
// });
// },
...
//
// style: TextStyle(
// color: _isAnswered[_currentIndex]
// ? Colors.green
//     : Colors.red,
// ),
// ),
